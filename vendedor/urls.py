...
urlpatterns = [
    ...
    # Workflow de criação de pedidos (multi-step)
    path('pedidos/novo/cliente/', views.pedido_step1_cliente, name='pedido_create_step1'),
    path('pedidos/<uuid:pk>/elevador/', views.pedido_step2_elevador, name='pedido_create_step2'),
    path('pedidos/<uuid:pk>/portas/', views.pedido_step3_portas, name='pedido_create_step3'),
    path('pedidos/<uuid:pk>/cabine/', views.pedido_step4_cabine, name='pedido_create_step4'),
    path('pedidos/<uuid:pk>/resumo/', views.pedido_resumo, name='pedido_resumo'),
