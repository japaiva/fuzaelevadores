...
urlpatterns = [
    # Página de login
    path('login/', ProducaoLoginView.as_view(), name='login'),
    ...
    path('produtos-intermediarios/<uuid:pk>/status/', views.produto_intermediario_toggle_status, name='produto_intermediario_toggle_status'),
